"""构造测试 · 拉格朗日中值定理族（packs/calculus/families/lagrange.py，D8-6 包内化）。

委托 v1 repo 根 families 的 lm_xi 族完成枚举。校验项同 rolle（见 test_family_rolle.py）。
注意：lm_rate 族语义不清，本任务未迁移（登记于 D8-6 汇报），此处仅覆盖 lm_xi。
"""
