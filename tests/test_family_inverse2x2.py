"""构造测试 · 二阶逆矩阵族（packs/linear/families/inverse2x2.py，D8-6 包内化）。

委托 v1 repo 根 families 的 inverse_2x2 族完成枚举。校验项同 rolle。
答案为 Matrix 表达式，解析需注入 locals={"Matrix": sympy.Matrix}。
"""
